...
<body>
<?php
require_once("../controller/cInfoArticulo.php");
...
<?php
    ...
    ?>
 <form method="post" action="../controller/cAgregarComentarioArticulo.php">
        <input type="hidden" name="codigo" value="<?php echo "$codigo"?>">  
        <textarea name="comentario" rows="10" cols="30"></textarea><br>
        <input type="submit" name='btnAgregarComentario' value='Agregar Comentario'>
</form>
